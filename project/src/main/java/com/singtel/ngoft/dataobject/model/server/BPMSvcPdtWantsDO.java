...
/**
 * <p>Java class for BPMSvcPdtWantsDO complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BPMSvcPdtWantsDO">
 *   &lt;complexContent>
 ...
 *         &lt;element name="svcPdtChildInfo" type="{http://www.singtel.com/oft/dataobject/xsd/server}BPMSvcPdtChildWantsDO" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class BPMSvcPdtWantsDO
    extends BPMSvcPdtDO
    implements Serializable
{

    protected List<BPMProdParameterWantsDO> prodParameter;
    protected List<BPMSvcPdtChildWantsDO> svcPdtChildInfo;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BPMSvcPdtChildWantsDO }
     * 
     * 
     */
    public List<BPMSvcPdtChildWantsDO> getSvcPdtChildInfo() {
        if (svcPdtChildInfo == null) {
            svcPdtChildInfo = new ArrayList<BPMSvcPdtChildWantsDO>();
        }
